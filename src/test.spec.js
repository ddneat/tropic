...
miniTest('test adds to state.test', () => {
  ...
  assert.strictEqual(state.test.length, 1)
})
...
miniTest('test does not add to state.only', () => {
  ...
  assert.strictEqual(state.only.length, 0)
})
...
miniTest('test does not add to state.skip', () => {
  ...
  assert.strictEqual(state.skip.length, 0)
})
...
miniTest('only adds to state.only', () => {
  ...
  assert.strictEqual(state.only.length, 1)
})
...
miniTest('only does not add to state.test', () => {
  ...
  assert.strictEqual(state.test.length, 0)
})
...
miniTest('skip adds to state.skip', () => {
  ...
  assert.strictEqual(state.skip.length, 1)
})
